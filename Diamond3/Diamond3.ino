...
#define SINE_LENGTH 335

int sine[SINE_LENGTH+1] = {15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,1,1,1,2,2,3,4,5,5,6,7,9,10,11,12,14,15,16,18,20,21,23,25,27,29,31,
  ...
  76,73,70,67,64,62,59,56,54,51,49,46,44,42,39,37,35,33,31,29,27,25,23,21,20,18,16,15,14,12,11,10,9,7,6,5,5,4,3,2,2,1,1,1,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,0};
...
void zeroCross(){
  ...
  for (int i=0;i<SINE_LENGTH;i++){ 
   ...
   if (D0_pos>SINE_LENGTH-mn) D0_pos=mn;
   if (D1_pos>SINE_LENGTH-mn) D1_pos=mn;
   if (D2_pos>SINE_LENGTH-mn) D2_pos=mn;
   if (D3_pos>SINE_LENGTH-mn) D3_pos=mn;  
   if (D4_pos>SINE_LENGTH-mn) D4_pos=mn;
   if (D5_pos>SINE_LENGTH-mn) D5_pos=mn; 
   if (D6_pos>SINE_LENGTH-mn) D6_pos=mn; 
   if (D7_pos>SINE_LENGTH-mn) D7_pos=mn; 
